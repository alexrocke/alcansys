...
export function LandingHeader() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/10 bg-[hsl(222,47%,11%)]/80 backdrop-blur-lg">
      <div className="max-w-6xl mx-auto flex items-center justify-between px-6 h-20 md:h-24">
        <img src={logo} alt="Scalefy" className="h-12 md:h-14 w-auto max-w-[220px] md:max-w-[260px] object-contain" />
